    ...
    >
      <div className="container h-100  py-0">
        <div className="row m-0 py-0 h-100 d-flex align-items-center justify-content-between">
          <div className="col-lg-5 col-12 p-0   rounded-4 overflow-hidden order-lg-0 order-1">
            <Svg6 />
          </div>{" "}
          <motion.div className="col-lg-6 col-12 text-lg-start textx p-0 order-lg-1 order-0">
